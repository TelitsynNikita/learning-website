...
document.addEventListener('DOMContentLoaded', () => {
    headerNav.addEventListener('click', (e) => {
        switch(e.target.className) {
            ...
            case 'baccalaureate':
                main.innerHTML = `
                    <section class="main__applicans main__applicans_baccalaureate">
                        <h2 class="main__applicans_title">Что такое бакалавриат?</h2>
                        <span>
                    ...
                    <section class="main__applicans">
                        <h2 class="main__applicans_title">Преимущества обучения на бакалавриате</h2>
                        <ul>
                            <li>
